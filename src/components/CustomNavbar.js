            ...
            <div className={`container ${cClass}`}>
              ...
              >
                <ul className={`navbar-nav menu ml-auto ${nClass}`}>
                  ...
                  <li className="nav-item">
                    <NavLink title="Pricing" className="nav-link" to="/Service">
                      Service
                    </NavLink>
                  </li>
                  ...
                  <li className="nav-item">
                    <NavLink title="" className="nav-link" to="/Contact">
                      Contact
                    </NavLink>
                  </li>
                </ul>
                <NavLink className={`btn_get btn_hover ${hbtnClass}`} to="/Contact">
                Get Started
                    </NavLink>
