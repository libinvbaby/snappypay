...
Richford, VT 05476
              ...
              <div className="contact_info_item">
                ...
                <p className="f_400 f_size_15">
                  <span className="f_400 t_color3">Customer Support:</span>{" "}
                  <a href="mailto: Helpdesk@SnappyPay.com"> Helpdesk@SnappyPay.com</a>
                </p>
                <p className="f_400 f_size_15">
                  <span className="f_400 t_color3">General Inquiries:</span>{" "}
                  <a href="mailto:Info@SnappyPay.com">Info@SnappyPay.com</a>
                </p>
                <p className="f_400 f_size_15">
                  <span className="f_400 t_color3">Sales:</span>{" "}
                  <a href="mailto:Sales@SnappyPay.com">Sales@SnappyPay.com</a>
                </p>
              </div>
            </div>
            <div className="contact_form col-lg-9">
